  ...
  return (
    <div className="navbar__editing nav-child">
      ...
      <IconElement
        ...
        title="Undo"
        label="Undo"
        disabled={!props.historyStep}>
        <UndoIcon />
      </IconElement>
      <IconElement
        buttonType="bold-btn"
        handleClick={() => {
          formatText("**strong text**", "**", "**");
        }}
        title="Bold"
        label="Bold">
        <BoldIcon />
      ...
      <IconElement
        buttonType="italic-btn"
        handleClick={() => {
          formatText("*emphasized text*", "*", "*");
        }}
        title="Italic"
        label="Italic">
        <ItalicIcon />
      ...
      <IconElement
        buttonType="strike-btn"
        handleClick={() => {
          formatText("~~strikethrough text~~", "~~", "~~");
        }}
        title="Strikethrough"
        label="Strikethrough">
        <StrikeThroughIcon />
      ...
      <IconElement
        buttonType="link-btn"
        handleClick={() => {
          props.setMarkdownImagelink(false);
          props.toggleModal();
        }}
        title="Link"
        label="Link"
      ...
      <IconElement
        buttonType="imagelink-btn"
        handleClick={() => {
          props.setMarkdownImagelink(true);
          props.toggleModal();
        }}
        title="Image"
        label="Image">
